...
- **[chrome_devtools_debugger_design.md](chrome_devtools_debugger_design.md)**: Comprehensive design document for a Chrome-integrated Scheme debugger. It covers the architecture (Debug Runtime, Source Maps, DevTools), implementation phases, and UI considerations.
