 ...
 * Supports originalName for user-facing display names distinct from
 * alpha-renamed internal names.
 */

/**
 * @typedef {Object} StackFrame
 * @property {string} name - Display name (prefers originalName over internal name)
 * @property {string} internalName - Alpha-renamed internal name
...
export class StackTracer {
   ...
   * Uses the display name (which prefers originalName) for functionName.
