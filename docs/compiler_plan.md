...
| 31 | | **Flonum fast paths** | — | Inline expansions still guard `bigint` only; flonum is 13.1x behind Gambit. They are emitter code: `inline.scm`. | R56 |
